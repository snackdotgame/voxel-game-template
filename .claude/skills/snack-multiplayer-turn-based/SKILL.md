---
name: snack-multiplayer-turn-based
description: Implement authoritative turn-based or discrete command multiplayer in generated Snack.Game projects. Use after selecting a command/state-machine approach for card games, board games, party rounds, lobbies, inventories, or other actions that can wait for reliable server responses.
---
...
- [references/example.md](references/example.md) for a command/revision implementation

Use this skill only after `snack-build-multiplayer` selects the turn-based/discrete path.
