...
export class Camera {
   ...
   */
  declare sensitivityMultOutsidePointerlock: number;
  ...
  /** @internal */
  declare _dirVector: any;

  // lazily initialized by `cameraObstructionDistance` below
  /** @internal */
  declare _sweepBox: any;
  /** @internal */
  declare _sweepGetVoxel: any;
  /** @internal */
  declare _sweepVec: any;
  /** @internal */
  declare _sweepHit: any;

  /**
   * @internal
   */
  constructor(noa: Engine, _opts: Partial<CameraDefaults>) {
    // merged into a local so TS sees the fully-populated defaults type
    var opts = Object.assign({}, new CameraDefaults(), _opts);
    this.noa = noa;
...
function bugFix(pointerState: any) {
